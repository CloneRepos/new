@ST_39361 @tagtagtag @this_is_story_tag
...
@SC_195753 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_195754 @third_scenario_tag
...
@SC_195755 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_195756 @fifth_scenario_tag
